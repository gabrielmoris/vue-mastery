      ...
      <div class="card">
        ...
        <div class="card-body">
          <form @submit.prevent="submit">
            <div class="mb-2">
              <!-- I use :value and @input instead of v-model -->
              <input
                type="text"
                class="form-control"
                placeholder="Name"
            ...
            <div class="mb-2">
              <!-- The child emits the value. With the Colon (:) I can say the name of the prop I send -->
              <EmailInput v-model:modelValue="newsletterEmail" />
              <!-- This is the same -->
              <!-- <EmailInput
...
<script>
import EmailInput from "@/components/ControlledComponent.vue";
export default {
  name: "App",
